...
public class FunctieGenerator {
    ...
    public double getY(double x){
        double y = (Math.sin((2*Math.PI*x)/a)+Math.sin((2*Math.PI*x)/b)+Math.sin((2*Math.PI*x)/c)+Math.sin((2*Math.PI*x)/d))*((amplitude/4)-20)+amplitude;
        return y;
    }
